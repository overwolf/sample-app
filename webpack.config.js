...
module.exports = env => ({
    entry: {
        ...
        second_screen: './src/second_screen/second_screen.ts'
    },
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: './src/second_screen/second_screen.html',
            filename: path.resolve(__dirname, './dist/second_screen.html'),
            chunks: ['second_screen']
        }),
